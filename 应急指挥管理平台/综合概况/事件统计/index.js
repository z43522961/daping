...
return class item extends Base {
    ...
    render(h, data, opts) {
        return ( <
            div class = "main"
            style = {
                { background: `url(${this.images.background})` } } >
            <
            div class = "title"
            style = {
                { background: `url(${this.images.titleBackground})` } } >
            <
            div class = "title_icon"
            style = {
                { background: `url(${this.images.titleIcon})` } } > < /div> <
            ...
            div class = "legend"
            style = {
                { background: `url(${this.images.accident})` } } >
            <
            ...
            div class = "legend"
            style = {
                { background: `url(${this.images.polling})` } } >
            <
            ...
            style = {
                { background: `url(${this.images.safe})` } } >
            <
            ...
            div class = "legend"
            style = {
                { background: `url(${this.images.hiddenDanger})` } } >
            <
            ...
            div class = "legend"
            style = {
                { background: `url(${this.images.educate})` } } >
            <
            ...
            div class = "legend"
            style = {
                { background: `url(${this.images.manoeuvre})` } } >
            <
