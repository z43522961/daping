...
return class item extends Base {
    ...
    render(h, data, opts) {
        return ( <
            div class = "main"
            style = {
                { background: `url(${Ia9c2cd1fa4044867abc67f4986c5179c})` }
            } >
            <
            div style = {
                { background: `url(${Id557798a4e044fc7b18562c94c5cb453})`, width: '100%', height: '100%' }
            } >
            <
            div class = "title"
            style = {
                { background: `url(${I14754fef31d644ba88460bc342c126d6})` }
            } >
            <
            div class = "title_icon"
            style = {
                { background: `url(${I11b494c6a4b84f16bad0f9f0179bdcda})` }
            } > < /div> <
            span class = "title_text" > { opts.menu.chart.title } < /span> < /
            div > <
            div class = "left"
            style = {
                { background: `url(${I18c1d00cbb4e411bb93c3fbe1babcec0})` }
            } >
            <
            ...
            div class = "right"
            style = {
                { background: `url(${Ie75eeb0f0e4840cdae821e30b3682365})` }
            } >
            <
